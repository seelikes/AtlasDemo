...
//    }
    ...
    public void startChildActivity(ViewGroup container, String key, Intent intent){
        ...
        Log.i(ActivityGroupDelegate.class.getSimpleName(), "startChildActivity.UL1212LP.DI1211, contentActivity!=null: " + (contentActivity!=null));
    ...
    public void execStartChildActivityInternal(ViewGroup container,String key, Intent intent){
        ...
        Log.i(ActivityGroupDelegate.class.getSimpleName(), "execStartChildActivityInternal.UL1212LP.DI1211, componentName: " + componentName + "; bundleName: " + bundleName);
